...
Date:		11/2016
Content:	addUser.php for CS340 final project, an outdoor adventure app database.
 -->
...
if(!($stmt = $mysqli->prepare("INSERT INTO user(f_name, l_name, dob, zip_code) VALUES (?,?,?,?)"))){
...
if(!($stmt->bind_param("sssi",$_POST['FirstName'],$_POST['LastName'],$_POST['DOB'],$_POST['ZipCode']))){
