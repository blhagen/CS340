...
Date:		11/2016
Content:	addAdventure.php for CS340 final project, an outdoor adventure app database.
 -->
...
if(!($stmt = $mysqli->prepare("INSERT INTO adventures(description, uid, depart_date, return_date) VALUES (?,?,?,?)"))){
...
if(!($stmt->bind_param("siss",$_POST['description'],$_POST['userID'],$_POST['departDate'],$_POST['returnDate']))){
...
//should successfully add one row to bsg_people.
	...
	echo "Added " . $stmt->affected_rows . " adventure.";
}
$stmt->close();
