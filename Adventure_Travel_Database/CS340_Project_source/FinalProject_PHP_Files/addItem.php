...
Date:		11/2016
Content:	addItem.php for CS340 final project, an outdoor adventure app database.
 -->
...
if(!($stmt = $mysqli->prepare("INSERT INTO item(lid, description) VALUES (?,?)"))){
...
if(!($stmt->bind_param("is",$_POST['listID'], $_POST['itemDescription']))){
...
//should successfully add one row to bsg_people.
	...
	echo "Added " . $stmt->affected_rows . " item.";
}
