...
Date:		11/2016
Content:	deleteTribeByUser.php for CS340 final project, an outdoor adventure app 	
		database.
 -->
...
if(!($stmt = $mysqli->prepare("DELETE FROM tribes WHERE tribes.uid = ? AND tribes.tribe_name = ?"))){
...
if(!($stmt->bind_param("is",$_POST['userID'],$_POST['tribe_name']))){
...
//should successfully add one row to bsg_people.
	...
	echo "Removed " . $stmt->affected_rows . " tribe.";
}
