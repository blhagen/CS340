...
Date:		11/2016
Content:	addUser_Adventure.php for CS340 final project, an outdoor adventure app database.
 -->
...
if(!($stmt = $mysqli->prepare("INSERT INTO user_adventure(uid, aid) VALUES (?,?)"))){
...
if(!($stmt->bind_param("ii",$_POST['userID'], $_POST['adventureID']))){
...
//should successfully add one row to bsg_people.
	...
	echo "Added " . $stmt->affected_rows . " user-adventure relationship.";
}
