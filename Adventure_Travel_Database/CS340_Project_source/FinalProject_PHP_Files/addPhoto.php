...
Date:		11/2016
Content:	addPhoto.php for CS340 final project, an outdoor adventure app 	
		database.
 -->
...
if(!($stmt = $mysqli->prepare("INSERT INTO photo(uid, date_created) VALUES (?,?)"))){
...
if(!($stmt->bind_param("is",$_POST['userID'],$_POST['photoDate']))){
