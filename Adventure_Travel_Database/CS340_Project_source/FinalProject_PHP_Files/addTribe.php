...
Date:		11/2016
Content:	addTribe.php for CS340 final project, an outdoor adventure app database.
 -->
...
if(!($stmt = $mysqli->prepare("INSERT INTO tribes(uid, tribe_name) VALUES (?,?)"))){
...
if(!($stmt->bind_param('is', $_POST['uid'],$_POST['tribe_name']))){
...
//should successfully add one row to bsg_people.
	...
	echo "Added " . $stmt->affected_rows . " tribe to user.";
}
$stmt->close();
?>